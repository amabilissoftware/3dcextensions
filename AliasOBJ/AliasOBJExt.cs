namespace TDCPluginImportExport9
{
    ...
    /// <summary>
    /// The implementation of a Alias OBJ Import/Export plug-in. 
    /// If you change the class name, change the assembly name to match
    /// </summary>
    public class AliasOBJExt : PluginImportExport
    {
        /// <summary>
        ...
        /// </summary>
        public string FileTypeDescription => "Alias OBJ (Downloaded Extension)";
